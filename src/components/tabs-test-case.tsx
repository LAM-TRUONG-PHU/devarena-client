...
export function TabsTestCase() {
    const [tabs, setTabs] = useState([
        { id: "1", name: "Case 1", content: "Content for Case 1", removable: false },
        { id: "2", name: "Case 2", content: "Content for Case 2", removable: false },
        { id: "3", name: "Case 3", content: "Content for Case 3", removable: false },
    ]);
    ...
    const handleAddTab = () => {
        ...
        setTabs([
            ...tabs,
            { id: newId, name: `Case ${newId}`, content: `Content for Case ${newId}`, removable: true },
        ]);
        setActiveTab(newId);
    };
        ...
        >
            ...
            {tabs.map((tab) => (
                <TabsContent key={tab.id} value={tab.id} className="flex-1">
                    <div className="bg-black h-full w-full text-white p-4">{tab.content}</div>
                </TabsContent>
            ))}
            ...
            <TabsContent value="result" className="mt-4">
                ...
                <div className="font-semibold text-lg text-center">Run tests to check your code</div>
